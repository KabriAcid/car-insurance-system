...
<head>
    ...
    <style>
        ...
        .container-fluid {
            padding-left: 20px; /* Additional padding for content */
            flex-grow: 1; /* Ensure main content takes remaining height */
        }
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT 
                                    ...
                                    pa.application_date
                                FROM 
                                    policy_applications pa
                                INNER JOIN 
                                    users u ON pa.user_id = u.id
                                INNER JOIN 
                                    policies p ON pa.policy_id = p.id";
